...
class Sphere : Object {
    ...
    func intersectionsWith(ray: Ray) -> [Intersection] //transform ray in world coordinates into ray in sphere coordinates to see it it intersects with the object in the world-- transform the ray by the inverse of the sphere transform
    {
    ...
    func normalAt(point: Tuple) -> Tuple //return a normalized vector from origin to point on surface (orthogonal to sphere)
    {
